...
class Corredor{
    ...
    public function setTempoCorridaDAO($data){
    ...
    public function corredorToCsv(){
        return $this->numero.";".$this->nome.";". ($this->chegada == null ? "Não registrado": $this->getChegadaFormatado()) .";". ($this->tempo_corrida == null ? "Não registrado": $this->tempo_corrida) .";"
        .$this->categoria.";"."\n";
    }
}